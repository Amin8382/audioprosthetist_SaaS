...
import com.audiosoin.audit.AuditLog;
import com.audiosoin.audit.AuditLogRepository;
...
import com.audiosoin.vente.BLLigne;
import com.audiosoin.vente.BLLigneRepository;
...
public class FactureService {
    ...
    public String getPdfContent(UUID id) {
        return "PDF placeholder for facture " + id;
    }
}
