...
import CnamList from './modules/cnam/CnamList';
import CnamForm from './modules/cnam/CnamForm';
import CnamDetail from './modules/cnam/CnamDetail';
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
        ...
        <Route path="cnam" element={<CnamList />} />
        <Route path="cnam/new" element={<CnamForm />} />
        <Route path="cnam/:id" element={<CnamDetail />} />
