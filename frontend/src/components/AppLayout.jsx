...
import { 
  ...
  Wallet, Shield, Settings, LogOut, Bell, Menu, X,
  Store, ShoppingCart, ListOrdered
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/cnam', label: 'CNAM', icon: Shield },
    ...
    <div className="flex h-screen bg-gray-50">
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-white border-r transform transition-transform lg:translate-x-0 lg:static ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex items-center justify-between h-16 px-6 border-b">
          <h1 className="text-xl font-bold text-primary-600">Audiosoin</h1>
