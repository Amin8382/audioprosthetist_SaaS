      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          ...
          <dl className="space-y-3">
            ...
            <div><dt className="text-sm text-gray-500">N° CNAM</dt><dd className="font-medium">{client.cnamNumber || '-'}</dd></div>
            <div><dt className="text-sm text-gray-500">Affiliation</dt><dd className="font-medium">{client.cnamAffiliationType || '-'}</dd></div>
          </dl>
        </div>
        {historique && (
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            ...
            <p className="text-sm text-gray-500">Demandes CNAM: {historique.cnam?.length || 0}</p>
          </div>
        )}
      </div>
    </div>
