...
public class FournisseurController {
    ...
    @GetMapping("/bons-commande/{id}/print")
    public ResponseEntity<byte[]> printBc(@PathVariable UUID id) {
        byte[] pdf = fournisseurService.getBcPdf(id);
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=\"BC-" + id + ".pdf\"")
    ...
    private final com.odyio.fournisseur.BonCommandeRepository bcRepository;
    private final com.odyio.fournisseur.TicketReparationRepository ticketRepository;
}
