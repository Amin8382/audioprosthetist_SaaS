...
public class TresorerieService {
    ...
    public byte[] getBordereauPdf(LocalDate start, LocalDate end) {
        List<TresorerieMouvement> mouvements = getBordereau(start, end);
        return pdfService.generateBordereauPdf(mouvements, start, end);
    }
}
